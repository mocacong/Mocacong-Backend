...
public class MemberAcceptanceTest extends AcceptanceTest {
    ...
    void findMyReviewCafes() {
        ...
        카페_등록(new CafeRegisterRequest(mapId1, "메리네 카페", "서울시 강남구"));
        카페_등록(new CafeRegisterRequest(mapId2, "케이네 카페", "서울시 강남구"));
    ...
    void getUpdateProfileInfo() {
        ...
        GetUpdateProfileInfoResponse actual = RestAssured.given().log().all()
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .auth().oauth2(token)
                ...
                .statusCode(HttpStatus.OK.value())
                .extract()
                .as(GetUpdateProfileInfoResponse.class);
